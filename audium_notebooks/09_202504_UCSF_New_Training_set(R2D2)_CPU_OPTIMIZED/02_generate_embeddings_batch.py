#!/usr/bin/env python3
"""
Generate HeAR embeddings for all complete patients in batches
Optimized for better performance and progress tracking
"""
...
def main():
    parser = argparse.ArgumentParser(description='Generate HeAR embeddings in batches')
